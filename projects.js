const projects = [
	{
		'name': 'Book 3 KURT',
		'description': 'Дпломная работа для Радиотехнического техникума. Шаблон электронного учебника, в котором написаны системы управления контентом, закладок, тестов и модальных окон. Реализован общий набор стилей и компонентов.',
		'date': 'December 2020',
		'tag': ['html', 'css', 'js'],
		...
		'name': 'Scripts main page',
		'description': 'Титульная страница со всеми игровыми скриптами, с их ссылками в Google Маркете и инструкцией установки.',
		'date': 'June 2019',
		'tag': ['html', 'css', 'js'],
		'href': 'game_scripts'
	}, {
