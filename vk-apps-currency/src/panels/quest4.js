...
const Quest4 = ({ id, go, next, setCheck }) => (
	<Panel name="head" id={id} theme="white">
		...
		<Div>
			<Button style={{opacity: .5, pointerEvents: 'none'}} name="next" size="xl" onClick={next} data-to="quest_finish" level="secondary">Результат</Button>
