...
const Quest3 = ({ id, go, next, setCheck }) => (
	<Panel name="head" id={id} theme="white">
		...
		<Div>
			<Button style={{opacity: .5, pointerEvents: 'none'}} name="next" size="xl" onClick={next} data-to="quest4" level="secondary">Следующий вопрос</Button>
