...
const debug = createDebug__default['default']('vk-io:util:fetch-cookie');
...
const debug$1 = createDebug__default['default']('vk-io:authorization:direct');
...
const debug$2 = createDebug__default['default']('vk-io:authorization:implicit-flow');
const { PAGE_BLOCKED, INVALID_PHONE_NUMBER: INVALID_PHONE_NUMBER$1, AUTHORIZATION_FAILED: AUTHORIZATION_FAILED$1, FAILED_PASSED_CAPTCHA: FAILED_PASSED_CAPTCHA$1, FAILED_PASSED_TWO_FACTOR: FAILED_PASSED_TWO_FACTOR$1 } = exports.AuthErrorCode;
/**
 * Blocked action
 */
...
const debug$3 = createDebug__default['default']('vk-io:authorization:implicit-flow-user');
...
const debug$4 = createDebug__default['default']('vk-io:authorization:implicit-flow-user');
const { AUTHORIZATION_FAILED: AUTHORIZATION_FAILED$3 } = exports.AuthErrorCode;
...
const debug$5 = createDebug__default['default']('vk-io:authorization:account-verification');
const { INVALID_PHONE_NUMBER: INVALID_PHONE_NUMBER$2, AUTHORIZATION_FAILED: AUTHORIZATION_FAILED$4, FAILED_PASSED_CAPTCHA: FAILED_PASSED_CAPTCHA$2, FAILED_PASSED_TWO_FACTOR: FAILED_PASSED_TWO_FACTOR$2 } = exports.AuthErrorCode;
/**
 * Two-factor auth check action
 */
...
class AccountVerification {
    ...
    async run(redirectUri) {
        ...
        while (isProcessed) {
            ...
            const $ = cheerio.load(await response.text());
            if (url$1.includes(ACTION_AUTH_CODE$1)) {
                response = await this.processTwoFactorForm(response, $);
                continue;
            }
            if (url$1.includes(ACTION_SECURITY_CODE$2)) {
                response = await this.processSecurityForm(response, $);
                continue;
            }
