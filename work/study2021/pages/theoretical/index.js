var data = {
	...
	'text': `
		...
		<div class="text">
			...
			<div class="card" onclick="window.open('?page=theoretical&list=1.1', '_top');">
			...
			<div class="card" onclick="window.open('?page=theoretical&list=2.1', '_top');">
			...
			<div class="card" onclick="window.open('?page=theoretical&list=3.1', '_top');">
			...
			<div class="card" onclick="window.open('?page=practical', '_top');">
