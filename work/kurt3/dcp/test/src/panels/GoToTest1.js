...
const GoToTest1 = ({ id, go, next, setCheck }) => (
	<Panel id={id}>
		<PanelHeader
		...
		<Div className="headbutton">
			<Div className="d-flex">
				<Button size="l" style={{opacity: .5, pointerEvents: 'none'}} name="next" level="outline" onClick={next} data-to="GoToTest2">
					Следующий вопрос
				</Button>
			</Div>
			<Div className="d-flex">
